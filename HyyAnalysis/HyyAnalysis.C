  ...
  if(fChain->GetTree()->GetEntries()>0)
      ...
      if(trigP)
	{
	  ...
	  for(unsigned int i=0; i<photon_n; i++)
	    {
//          FillHistogramsGlobal( photon_pt->at(i), weight, "hist_photon_pt"); // 30 bins
//          FillHistogramsGlobal( photon_eta->at(i), weight, "hist_photon_eta"); // 30 bins
//          FillHistogramsGlobal( photon_phi->at(i), weight, "hist_photon_phi"); // 30 bins
	  ...
	  if(goodphoton_n==2 )
	    {
	      ...
	      int goodphoton1_index = 0;
	      int goodphoton2_index = 1;
